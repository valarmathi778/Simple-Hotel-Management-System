...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 20, 2024 at 10:10 AM
...
(1, 'valar@28', 'mvalar381@gmail.com');
...
CREATE TABLE `food` (
  ...
  `Serving_Size` int(50) NOT NULL,
  `Food_Image` varchar(255) NOT NULL,
  `Image_Type` varchar(255) NOT NULL,
  `Description` varchar(255) NOT NULL,
  `country` int(255) NOT NULL,
  `states` int(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `food` (`Food_Id`, `Recipe_Name`, `Ingredients`, `Meal_Type`, `Cuisine`, `Serving_Size`, `Food_Image`, `Image_Type`, `Description`, `country`, `states`) VALUES
(46, 'Briyani', 'Water,Rice,Vegetables,Briyani Masalas,Spices,Ghee,Oil', 'Lunch', 'Indian', 5, 'Briyani.jpeg', 'Briyani Rs.150', 'Biryani is a celebratory rice and meat dish cherished in the Indian sub-continent. A traditional biryani consists of fluffy basmati rice layered over tender & succulent pieces of meat, accompanied with the mesmerizing aromas of spices, herbs & caramelized', 0, 0),
(48, 'Chicken Fry', 'Raw Chicken,oil,masalas,onion,', 'Sidedish', 'Indian', 5, 'Chicken Fry.jpeg', 'Chicken Fry: Rs.50', 'Delicious chicken pieces fried to perfection, served hot and crispy.It is very tasted and yummy side dish for all foods.', 0, 0),
(49, 'Chapati', 'Wheat Flour,oil,Water,salt', 'Breakfast', 'North Indian', 5, 'Chapatti.jpeg', 'Chapati Set: Rs.30', 'Chapati, also known as roti, is a staple Indian flatbread food.It is a weight loss recipe.it have less faty contents,grains food....etc.', 0, 0),
(50, 'Paratto', 'Plain Flour,Oil,Water,Eggs,salt			', 'Dinner', 'Indian', 5, 'Parotta.jpeg', 'Paratto set:Rs.50', 'Paratto is a favourite food for childrens to oldagers. Our batter fully made up with wheat flour.This food fully fat free,contains grain contains.</', 0, 0),
(52, 'Pasta', 'Raw pasta, water, salt, Vegetables', 'Breakfast', 'chinese', 2, 'burger.jpg', 'Pasta: Rs.250', 'Pasta is a delicious food. children like this food very munch.', 0, 0),
(54, 'Noodles', 'Raw noodles,Water,Salt,Oil,Masla,Vegetables			', 'Breakfast', 'chinese', 2, 'Maggie.jpeg', 'Noodles Rs.80', 'Noodles is good for health because this raw noodles manufactured by wheat flour.</', 0, 0),
(55, 'Fried Rice', 'Boiled Rice, Vegetables, Masalas, Oil, Salt, Pepper Powder,  Ghee', 'Dinner', 'Indian', 4, 'Fried Rice.jpeg', 'Fried Rice:Rs.80', 'Fried rice is a popular and versatile dish made by stir-frying rice in a wok or frying pan, often with ingredients like vegetables, eggs, meat (such as chicken, shrimp, or pork), and flavorful seasonings like soy sauce, garlic, and ginger. The rice is typ', 0, 0),
(56, 'Full Meal', 'Rice,Dhal,Oil,Water,Wheat Flour,etc', 'Lunch', 'Indian', 5, 'Meal.jpeg', 'Full Meal:Rs.100', 'Meals can range from simple, quick-to-prepare dishes like sandwiches or salads to elaborate, multi-course experiences featuring appetizers, main dishes, sides, and desserts. They often bring people together for social or cultural gatherings, celebrating t', 0, 0),
(57, 'Dosa', 'Rice Batter,Oil,Salt', 'Breakfast', 'Indian', 2, 'Dosa.jpg', 'Dosa Set:Rs.50', 'Dosa is a popular South Indian dish known for its crispy texture and savory flavor. Its a type of thin, crepe-like pancake made from fermented rice and black gram batter. The batter is spread thinly on a hot griddle or tawa, resulting in a light crispy ex', 0, 0);
...
INSERT INTO `foodimages` (`Images`, `Image_Type`) VALUES
('images/Briyani.jpeg', 'Briyani\r\nRs.100'),
('images/Chicken Fry.jpeg', 'Chicken Fry\r\nRs.50'),
('images/Fried Rice.jpeg', 'Fried Rice\r\nRs.80'),
('images/Meal.jpeg', 'Full Meals\r\nRs.100');
...
INSERT INTO `foodregister` (`ID`, `Email`, `Password`, `Name`, `Phone_No`, `Country`, `States`) VALUES
(59, 'tejas27@gmail.com', '$2y$10$67vsDDcPioY2NNInUPEyrewswIe1Reymln.USN7/YbWI3JlJ0V3dq', '', '0', '0', '0'),
(60, 'user1@gmail.com', '$2y$10$9oqy0Bho.1ppWlXgbS/vme/B6yCkgnF3Y1OosyG7Kx6b/B0wYTKlK', '', '0', '0', '0'),
(61, 'mvalar381@gmail.com', '$2y$10$5afb38DZGEiF0okDbwOgW.IGrYAle8tJpEuD8KzlKZG8WlOgWr8Ci', 'mathi', '2147483647', '0', '0'),
(62, 'mvalar381@gmail.com', '$2y$10$Wxt.4gzVaDa/yQ5Xc3v3re1kpWi6WtmSKkvVYtbfXNT4D5e/9guZS', 'mathi', '2147483647', '0', '0'),
(63, 'mvalar381@gmail.com', '$2y$10$I0KtzVu877O.FahLLa/yiet0tZvoWZDkCQ6sYkKtI4MXMci2uYIvK', 'mathi', '2147483647', '0', '0'),
(64, 'user1@gmail.com', '$2y$10$SJml3dLGFNI0a6zxXEbplO4oDwSSe0gq9v5TqYZFq172R.JfiC7Zu', 'mathi', '2147483647', 'India', 'Tamilnadu'),
(67, 'valar@gmail.com', '$2y$10$6jBGoNHtlN.k6zI8G2F6N.npJRFRlFiwEqIH6hkOvToDWGHCR97Ua', 'valarmathi', '2147483647', '101', '35'),
(68, 'user@gmail.com', '$2y$10$Ol/rnD6YhKNckrVo0oVL0e0sBj8uVMTfjWWYGUHIQVgwMfvRBcsoG', 'user', '2147483647', '6', '183'),
(70, 'mvalar@gmail.com', '$2y$10$cvwGbRo9AYeLFl3iCsHbKOOdIYi0j7fq5n6wU7EkxqTx7j6bCl4aq', 'valarmathi', '6382772589', '101', '35'),
(71, 'user1@gmail.com', '$2y$10$4bI/07Wy6u0eZVMKHE9kJOZWztSC1uE0ipEhF0wIFD6dfH1EuPBS2', 'user1', '765493567', '2', '78'),
(72, 'user1@gmail.com', '$2y$10$z6DNjk/IIIfmAXZMYb44g.fCjdEpZB1TmHgI/zGY0GQZrVMVnfxiW', 'user1', '765493567', '2', '78'),
(73, 'user2@gmail.com', '$2y$10$AvLXT4rxvZUs09Qs1bWdkulM9/E775H0K77vTRY/htyIKZCC4WURq', 'user2', '9842060049', '101', '10'),
(74, 'user1@gmail.com', '$2y$10$pGCHINfLfwqAjWXCToIf3ehRJRtBuJ9tdF78LHkDg.JZWQwI08G2q', 'user1', '9842060049', '101', '35'),
(75, 'user2@gmail.com', '$2y$10$v185NgHVwgKvbSMWdDdYwOHMNTttvOYDIOudAkiquiX4B2Uw/a3iy', 'user2', '9042360049', '101', '35'),
(76, 'user2@gmail.com', '$2y$10$iSOimrW2gkvl2oQvPlmv8eh7Hfa9CYcxuKrLdv1i2MwJP5/zKOx.K', 'user2', '9042360049', '101', '35'),
(77, 'user3@gmail.com', '$2y$10$O1Di9bndM1GWHTXNzZIehOJMbADCwPD72feBvO9VG3zNno0Sn23G2', 'user3', '9042360049', '3', '121'),
(78, 'user3@gmail.com', '$2y$10$bnrotdLViDw277QldsMb4O.oQaDqPV78UTBH4EwVUTwi7ruPamrzO', 'user3', '9042360049', '3', '121'),
(79, 'user3@gmail.com', '$2y$10$hJoJxvmp9XhWUHo9.k18IuqtVLcRHnX0JGGbOkVcFYkOE.1HSdSiy', 'user3', '9042360049', '3', '121');
...
INSERT INTO `fooduser` (`ID`, `Name`, `Mobile_Number`, `Email`, `Guest`, `Date`, `Add_Info`) VALUES
(1, 'Valarmathi', 768543516, 'valar@gmail.com', 2, '08/02/2024', 'jhkgskuygkikvfyui'),
(2, 'Tejaswini', 2147483647, 'tejas@gmail.com', 1, '07/01/2024', 'test'),
(3, 'Valarmathi', 2147483647, 'mvalar381@gmail.com', 4, '07/16/2024', 'Birthday party'),
(4, 'Valarmathi', 2147483647, 'mvalar381@gmail.com', 2, '07/16/2024', 'birthday party'),
(5, 'Valarmathi', 2147483647, 'mvalar381@gmail.com', 2, '07/16/2024', 'Birthday Party'),
(6, 'Valarmathi', 2147483647, 'mvalar381@gmail.com', 3, '08/02/2024', 'jhygjyufduye5ysteredtfy'),
(7, 'Valarmathi', 2147483647, 'mvalar381@gmail.com', 4, '07/16/2024', 'nbdjgfjugirua'),
(8, '', 0, 'valarmathi@gmail.com', 0, '', ''),
(9, 'Valarmathi', 2147483647, 'valarmathi@gmail.com', 4, '07/16/2024', 'Birthday Party');
...
INSERT INTO `jobapplication` (`appln_id`, `name`, `email`, `phone`, `password`, `resume`) VALUES
(4, 'user1', 'user1@gmail.com', '1324658790', 'user1', 'ValarmathiC Resume.pdf');
...
(1, 'mvalar381@gmail.com', 'Valar28'),
(2, 'mvalar381@gmail.com', 'valar@28'),
(3, 'user1@gmail.com', 'user1'),
(4, 'user1@gmail.com', 'user1'),
(5, 'mvalar381@gmail.com', 'valar@28'),
(6, 'user1@gmail.com', 'user1'),
(7, 'user2@gmail.com', 'user2'),
(8, 'user1@gmail.com', 'user1'),
(9, 'mvalar381@gmail.com', 'valar@28'),
(10, 'user3@gmail.com', 'user3');
...
INSERT INTO `orderform` (`ID`, `Card_Number`, `CVV`, `UserId`, `Seats`, `Total_Price`, `FoodId`) VALUES
(59, '0', '0', '', '0', '0', 0),
(60, '0', '0', '', '0', '0', 0),
(61, '2147483647', '5002', '60', '2', '300', 49),
(62, '2147483647', '1020', '60', '2', '300', 50),
(63, '0', '0', '', '0', '0', 0),
(64, '0', '0', '', '0', '0', 0),
(65, '0', '0', '', '0', '0', 0),
(66, '0', '0', '', '0', '0', 0),
...
(69, '0', '0', '', '0', '0', 0),
(70, '', '', '', '', '', 0),
(71, '87652345098743', '4987', '', '3', '450.00', 0),
(72, '', '', '', '', '', 0),
(73, '', '', '', '', '', 0),
(74, '', '', '', '', '', 0),
(75, '763974866549873', '4987', '74', '4', '600.00', 52),
(77, '0023487650945', '6790', '76', '3', '450.00', 50),
(78, '98765432109823', '6578', '76', '2', '300.00', 50),
(79, '00234876509458', '9806', '76', '3', '450.00', 50),
(80, '763974866549873', '0987', '76', '3', '450.00', 50),
(81, '00234876509458', '7890', '76', '5', '750.00', 50);
...
--
-- Indexes for table `foodregister`
--
ALTER TABLE `foodregister`
  ADD PRIMARY KEY (`ID`);
...
--
ALTER TABLE `food`
  MODIFY `Food_Id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=58;

--
-- AUTO_INCREMENT for table `foodregister`
--
ALTER TABLE `foodregister`
...
--
ALTER TABLE `jobapplication`
  MODIFY `appln_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
