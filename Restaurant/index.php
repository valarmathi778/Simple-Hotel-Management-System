...
<!--//Login Form -->
 <section id="Application">
    <div class="application" id="careers">
        <div class="container">
...
<!--//Login Form -->
    <section id="login-w3ls">
		<div class="login-w3ls" id="login">
				<div class="containerlogin">
				<h3>Login Form</h3>
				<form action="register.php" method="post">
						<div class="a"> 
							<label class="header">Email :</label>
							<input type="email"  class="emailid" name="Email" id="email" placeholder="Enter Your Email" required="">
						</div>
						<div class="b"> 
							<label class="header">Password :</label>
							<input type="password"  class="password" name="password" id="pswd"  placeholder="Enter Your Password" required="">
						</div>
      ...
      <div class="modal-body">
        <form action="foodregister.php" method="post">
            ...
            <div class="form-group">
                ...
                <input type="tel" id="phno" name="phno" class="form-control" required>
            </div>
            ...
            <div class="form-group">
				...
				<?php
				require('connect.php');
				$query = "SELECT cont_id,name FROM countries ORDER BY name";
...
$(document).ready(function() {
    $('#country').on('change', function() {
        ...
        if (countryID) {
            $.ajax({
                type: 'POST',
                url: 'fetch_states.php', // Specify the path to the AJAX handler script
