...
<!--heder end here-->
		<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>View Food</li>
            </ol>
			...
			<div class="agile-tables">
					<div class="w3l-table-info">
						...
						?>
							...
							<td><img src="images/<?php echo $row['Food_Image']?>" width="50px" height="50px"></td>
							<td><?php echo $row['Image_Type']?></td>
							<td><?php echo $row['Description']?></td>
							<td><a href="edit.php?id=<?php echo $row["Food_Id"];?>"> Edit</a></td>
							<td><a href="delete.php?id=<?php echo $row["Food_Id"];?>"onclick="return confirm('Are you sure you want to delete this item?')"> Delete</a></td>
							<td><a href="approed.php">approved</a></td>
							<td><a href="reject.php">rejected</a></td>
							</tr>
						<?php
						  }
						 ?>
