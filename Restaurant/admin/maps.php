...
<!--heder end here-->
		<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>User Information</li>
            </ol>
	<div class="map">
			<div class="w3l-table-info">
						<?php 
							require('connect.php');
							$res = $con->query( "SELECT fr.*,c.name,s.sname FROM foodregister as fr 
							JOIN countries as c ON fr.country=c.cont_id 
							JOIN states as s ON s.stat_id=fr.states");
			                $count = $res->num_rows;
							if($count>0){
							?>
				...
				<div class="sidebar-menu">
					<header class="logo1">
						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
									<ul id="menu" >
										<li><a href="layout.php"><i class="fa fa-tachometer"></i> <span>Dashboard</span><div class="clearfix"></div></a></li>
