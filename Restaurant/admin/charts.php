...
<!--heder end here-->
		<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>View Candidates</li>
            </ol>
<div class="agile3-grids">
			<div class="agile-tables">
					<div class="w3l-table-info">
						<?php 
							require('connect.php');
							$res = $con->query( "SELECT * FROM jobapplication");
			                $count = $res->num_rows;
							if($count>0){
							?>
...
<td>
    <a href='uploads/resumes/<?php echo $row["resume"]; ?>' target="_blank">View Resume</a>
</td>
